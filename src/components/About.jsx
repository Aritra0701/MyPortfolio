    ...
    >
      <div>
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded">
                <a href="https://certificate.webskittersacademy.in/crtdls/aritra-halderreact-js-full-react-js-course-training/465-0/" target="blank">link</a>
                </button>
        <br />
        <br />
        <h1 className="text-green-600 font-semibold text-xl">
        ...
        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 py-2 rounded">
                <a href="https://www.coursera.org/account/accomplishments/verify/P6U6QJNAVKUC" target="blank">link</a>
                </button>
        <br />
        <br />
        <h1 className="text-green-600 font-semibold text-xl">
